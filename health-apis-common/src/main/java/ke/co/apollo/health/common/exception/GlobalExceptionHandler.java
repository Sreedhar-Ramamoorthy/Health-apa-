package ke.co.apollo.health.common.exception;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(value = {CompletionException.class, BusinessException.class})
  public ResponseEntity<DataWrapper> handleBusinessException(Exception e) {
    logger.error("Business Exception: ", e);
    String msg = e.getMessage();
    if (e instanceof CompletionException && StringUtils.isNotEmpty(msg)) {
        msg = msg.substring(msg.indexOf(":") + 1);
    }
    return ResponseEntity.ok(new DataWrapper(ReturnCode.EXCEPTION, msg, null));
  }
